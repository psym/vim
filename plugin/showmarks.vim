...
hi default ShowMarksHLl ctermfg=white ctermbg=black cterm=bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLu ctermfg=white ctermbg=black cterm=bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLo ctermfg=white ctermbg=black cterm=bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLm ctermfg=white ctermbg=black cterm=bold guifg=blue guibg=lightblue gui=bold
